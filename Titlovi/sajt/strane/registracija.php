...
<head>
	...
	<meta name="description" content="Forma za registraciju novog korisnika" />
	<meta name="keywords" content="registracija, forma, title, spisak, titlovi" />
					...
					if(isset($_REQUEST['btnSubmit'])){
						...
						if(count($greske) != 0){
							...
							if(move_uploaded_file($privremenoImeFajla, $putanjaSlike)){
								$upit_upis = "INSERT INTO tabel_korisnici VALUES('', '$korisnickoIme', '$lozinkaMD5', '$email', '$ime', '$prezime', '$pol', '$putanjaSlike', 'korisnik')";
